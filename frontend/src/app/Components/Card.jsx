    ...
    return (
     ...
     <section className="container mx-auto p-10 md:py-12 px-0 md:p-8 md:px-0 bg-[#F2F2F2]">
            <section
                ...
                <section className="p-5 py-10 bg-[#D93B65] text-center transform duration-500 hover:-translate-y-2 cursor-pointer">
                    <img src="https://www.dropbox.com/s/mlor33hzk73rh0c/x14423.png?dl=1" alt=""/>
                        <div className="space-x-1 flex justify-center mt-10">
                            <svg className="w-4 h-4 mx-px fill-current text-[#A62139]" xmlns="http://www.w3.org/2000/svg"
                                viewBox="0 0 14 14">
                                <path
                        ...
                        <button className="p-2 px-6 bg-[#A62139] text-white rounded-md hover:bg-[rgba(166,33,57,0.5)]">Add To Cart</button>
                </section>

                <section className="p-5 py-10 bg-[#485B73] text-center transform duration-500 hover:-translate-y-2 cursor-pointer">
                ...
                <section className="p-5 py-10 bg-[#BFA595] text-center transform duration-500 hover:-translate-y-2 cursor-pointer">
